Ôùç injected env (10) from .env // tip: Ôîÿ custom filepath { path: '/custom/path/.env' }
npx : Loaded Prisma config from prisma.config.ts.
En línea: 1 Carácter: 1
+ npx prisma migrate diff --from-migrations prisma/migrations --to-sche ...
+ ~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~
