...
export function Pagination({ page, totalPages, onPageChange }: Props) {
  ...
  return (
    <div className="flex items-center gap-1">
      <Button variant="outline" size="sm" className="h-7 w-7 p-0" disabled={page <= 1} onClick={() => onPageChange(1)} title="Primera pagina">
      ...
      <Button variant="outline" size="sm" className="h-7 w-7 p-0" disabled={page >= totalPages} onClick={() => onPageChange(totalPages)} title="Ultima pagina">
